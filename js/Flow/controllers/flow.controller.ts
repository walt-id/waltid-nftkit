...
class FlowController {
  ...
  async getNFTsByAddressInCollection(req: express.Request, res: express.Response) {
    const account = await FlowService.getNftsByAddressInCollection(req.body.account_id ,  req.body.collectionPath , req.body.chain)
    console.log(account);
    res.send(account);
  }
  ...
  async getAllNFTs(req: express.Request, res: express.Response) {
    ...
    const account = await FlowService.getAllNFTs(req.body.account_id , req.body.chain)
    console.log(account);
    res.send(account);
  }
