...
import id.walt.nftkit.CredentialNFT
...
class CredentialNFT : Contract {
    ...
    companion object {
        ...
        fun load(
            ...
            return CredentialNFT(contractAddress, web3j, credentials, gasPrice, gasLimit)
        }
        ...
        fun load(
            ...
            return CredentialNFT(contractAddress, web3j, transactionManager, gasPrice, gasLimit)
        }
        ...
        fun load(
            ...
            return CredentialNFT(contractAddress, web3j, credentials, contractGasProvider)
        }
        ...
        fun load(
            ...
            return CredentialNFT(contractAddress, web3j, transactionManager, contractGasProvider)
        }
        ...
        fun deploy(
            ...
            credentials: Credentials?,
            contractGasProvider: ContractGasProvider?
        ): RemoteCall<CredentialNFT> {
            return deployRemoteCall(CredentialNFT::class.java, web3j, credentials, contractGasProvider, BINARY, "")
        }
        ...
        fun deploy(
            ...
            return deployRemoteCall(CredentialNFT::class.java, web3j, credentials, gasPrice, gasLimit, BINARY, "")
        }
