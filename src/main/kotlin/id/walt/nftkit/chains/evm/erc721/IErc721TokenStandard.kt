...
interface IErc721TokenStandard {
    ...
    fun transferFrom(chain: Chain, contractAddress: String, from: Address, to: Address, tokenId: Uint256): TransactionReceipt
    fun safeTransferFrom(chain: Chain, contractAddress: String, from: Address, to: Address, tokenId: Uint256): TransactionReceipt
    fun safeTransferFrom(chain: Chain, contractAddress: String, from: Address, to: Address, tokenId: Uint256, data: DynamicBytes): TransactionReceipt
    ...
    fun approve(chain: Chain, contractAddress: String, to: Address, tokenId: Uint256):TransactionReceipt
