...
object ExtensionsController {
    ...
    fun updateTokenURI(ctx: Context) {
        ...
        val result = ExtensionsService.setTokenURI(Chain.valueOf(chain?.uppercase()!!),contractAddress, tokenId,updateTokenURIReq)
        ctx.json(
            result
        )
    }
    ...
    fun setTransferable(ctx: Context) {
        ...
        val chain = ctx.pathParam("chain")
        val contractAddress = ctx.pathParam("contractAddress")
        val result = ExtensionsService.setTransferable(Chain.valueOf(chain?.uppercase()!!),contractAddress, transferableReq.transferable)
        ctx.json(
            result
        )
    }
