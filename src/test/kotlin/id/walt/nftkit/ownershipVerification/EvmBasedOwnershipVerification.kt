...
/*
    "verify trait type and trait value in the metadata".config(enabled = enableTest){
        val resTrue =  VerificationService.verifyTrait(Chain.MUMBAI, "0xf277BE034881eE38A9b270E5b6C5c6f333Af2517", "0x2555e3a97c4ac9705d70b9e5b9b6cc6fe2977a74","3", traitType="t1", traitValue = "v1" )
